...
//		empList.add(new Employee(101, "Akshay", 10000));
//		empList.add(new Employee(102, "Amey", 18000));
//		empList.add(new Employee(103, "Rohan", 12000));
//		empList.add(new Employee(104, "Prasad", 15000));
//		empList.add(new Employee(105, "Shreyash", 20000));
//		
...
//		
//		//using filter() we can get spedified data
//		//Here employee details having salary more than 15000
//		Stream<Employee> employeesWithMoreSalary = empStream.filter(e -> e.salary>15000);
//		
//		//displaying employee details
//		System.out.println("Employees with salary more than 15000");
